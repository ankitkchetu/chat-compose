...
export class toagent extends Component {
    constructor(props) {
        super(props)
        this.state ={
            ...
            <div id="propwrap" className={(this.state.element&&this.state.element.data)?"itson":""}>
                    <div id="properties" className={(this.state.element&&this.state.element.data)?"expanded":''}>
                        ...
                        <div className={this.state.clicked==='dataprop' ? 'proplist' : "proplist hidden"}>
                            <p className="inputlabel">Queue Id of ameyo</p>
                            <input className="dropme" id='queueId' type="text" value={(this.state.element&&this.state.element.data&&(this.state.element.data.queueId))||''} onChange={this.handlerChange.bind(this)}/>
